...
class Performance_jank_kpi_05_000030(Case):
    ...
    def run_case(self):
        ...
        for test_time in range(0, self.TEST_TIME):
            ...
            # 点击右上角导航栏
            logging.info('点击右上角导航栏')
            SeaOfStarsAW.check_status(label='更多频道')
            ...
            # 进入电视剧tab（2s，停留2s）
            SeaOfStarsAW.check_status(xpath='//Window[1]/Other[1]/Other[1]/Other[1]/Other[1]/Other[1]/Other[1]/Other[3]/Other[1]/CollectionView[1]/Cell[6]/Other[1]/Other[1]')
            logging.info('进入电视剧tab')
            SeaOfStarsAW.ut_device(xpath='//Window[1]/Other[1]/Other[1]/Other[1]/Other[1]/Other[1]/Other[1]/Other[3]/Other[1]/CollectionView[1]/Cell[6]/Other[1]/Other[1]').click()
            time.sleep(2)
            step += 1
            SeaOfStarsAW.ut_device.screenshot(self.screenshot_dir_path + '/' + self.__class__.__name__ + 'step_' + str(step) + '_' +time.strftime('%H%M%S', time.localtime()) + '.png')
            ...
            # 点击免费
            SeaOfStarsAW.check_status(label='VIP/免费')
            logging.info('VIP/免费')
            SeaOfStarsAW.ut_device(label='VIP/免费').click()
            time.sleep(2)
            ...
            # 点击推荐的第一个视频播放
            SeaOfStarsAW.check_status(xpath='//Window[1]/Other[1]/Other[1]/Other[1]/Other[1]/Other[1]/Other[1]/Other[2]/Other[1]/CollectionView[1]/Cell[1]/Other[1]/Other[1]/Image[1]')
            logging.info('点击推荐的第一个视频播放')
            SeaOfStarsAW.ut_device(xpath='//Window[1]/Other[1]/Other[1]/Other[1]/Other[1]/Other[1]/Other[1]/Other[2]/Other[1]/CollectionView[1]/Cell[1]/Other[1]/Other[1]/Image[1]').click()
            time.sleep(5)
            step += 1
            SeaOfStarsAW.ut_device.screenshot(self.screenshot_dir_path + '/' + self.__class__.__name__ + 'step_' + str(step) + '_' +time.strftime('%H%M%S', time.localtime()) + '.png')
            # 先点击第一集
            ...
            for i in range(2):
                time.sleep(2)
                if SeaOfStarsAW.ut_device(label='会员关闭此广告').exists:
                    print(type(SeaOfStarsAW.ut_device(label='会员关闭此广告')))
                    print(i)
                ...
                if SeaOfStarsAW.ut_device(label='确认协议并支付').exists:
                    SeaOfStarsAW.ut_device(xpath='//Window[1]/Other[1]/Other[1]/Other[1]/Other[1]/Other[1]/Image[1]/Other[1]/Other[1]/Other[1]/Button[1]').click()
