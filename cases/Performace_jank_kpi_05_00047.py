...
class Performance_jank_kpi_05_000047(Case):
    ...
    def run_case(self):
        ...
        for test_time in range(0, self.TEST_TIME):
            ...
            # 主页下滑
            logging.info('主页下滑')
            SeaOfStarsAW.trace_thread.add_log('微信', '主页下滑')
            ...
            # 点击最近使用的小程序
            logging.info('点击最近使用的小程序')
            SeaOfStarsAW.trace_thread.add_log('微信', '点击最近使用的小程序')
            # SeaOfStarsAW.check_status(label="陕西一码通")
