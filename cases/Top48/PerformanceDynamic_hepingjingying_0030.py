...
#========================================================================================
#   @FileName:      PerformanceDynamic_hepingjingying_0030.py
...
class PerformanceDynamic_hepingjingying_0030(Case):
    all_app_package_list = ['com.tencent.tmgp.pubgmhd']
    TEST_TIME = 1
    ...
    def run_case(self):
        ...
        for test_time in range(0, self.TEST_TIME):
            ...
            logging.info("1、启动和平精英")
            SeaOfStarsAW.ut_device.app_start('com.tencent.tmgp.pubgmhd', use_monkey=True)
            time.sleep(20)
            ...
            # 2、返回home页，等待2s
            SeaOfStarsAW.start_perfetto_trace()
            logging.info("2、返回home页")
            SeaOfStarsAW.ut_device.app_stop('com.tencent.tmgp.pubgmhd')
            time.sleep(2)
