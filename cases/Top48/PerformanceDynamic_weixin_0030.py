...
class PerformanceDynamic_weixin_0030(Case):
    ...
    def run_case(self):
        ...
        step = "4、进入好友xxxx的详情界面(2s，停留2s)"
        SeaOfStarsAW.start_perfetto_trace()
        logging.info(step)
        SeaOfStarsAW.ut_device.click(500, 900)
        time.sleep(2)
        SeaOfStarsAW.stop_and_get_perfetto_trace(self.trace_dir_path, self.__class__.__name__,
                                                 'step_' + str(steps_num) + "-" + step, "", self.screenshot_dir_path)
        steps_num += 1
        ...
        step = "6、浏览图片(横向滑动6次，2s，停留2s）"
        SeaOfStarsAW.start_perfetto_trace()
        logging.info(step)
        SeaOfStarsAW.ut_device.click(300, 1500)
        time.sleep(1)
        for _ in range(3):
        ...
        time.sleep(1)
        SeaOfStarsAW.ut_device.click(800, 610)
        time.sleep(1)
        SeaOfStarsAW.stop_and_get_perfetto_trace(self.trace_dir_path, self.__class__.__name__,
                                                 'step_' + str(steps_num) + "-" + step, "", self.screenshot_dir_path)
        steps_num += 1
        ...
        SeaOfStarsAW.start_perfetto_trace()
        logging.info(step)
        SeaOfStarsAW.ut_device.click(940, 2000)
        time.sleep(1)
        SeaOfStarsAW.ut_device.click(940, 2000)
        time.sleep(1)
        SeaOfStarsAW.stop_and_get_perfetto_trace(self.trace_dir_path, self.__class__.__name__,
        ...
        step = "10、返回微信主界面（2s，停留2s）"
        SeaOfStarsAW.start_perfetto_trace()
        logging.info(step)
        SeaOfStarsAW.ut_device.click(540, 1270)
        time.sleep(1)
        SeaOfStarsAW.ut_device.click(80, 1500)
        time.sleep(1)
        SeaOfStarsAW.stop_and_get_perfetto_trace(self.trace_dir_path, self.__class__.__name__,
                                                 'step_' + str(steps_num) + "-" + step, "", self.screenshot_dir_path)
        steps_num += 1

        step = "11、返回home页面（2s，停留2s）"
        SeaOfStarsAW.start_perfetto_trace()
        logging.info(step)
