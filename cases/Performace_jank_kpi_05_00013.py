...
class Performance_jank_kpi_05_000013(Case):
    ...
    def run_case(self):
        ...
        for test_time in range(0, self.TEST_TIME):
            ...
            SeaOfStarsAW.trace_thread.add_log('高德地图', '搜索“西安北站（北进站口）')
            # 界面判断
            ...
            # 点击北进站口
            SeaOfStarsAW.ut_device.click(0.361, 0.627)
            time.sleep(2)

            # step3:点击路线，点击打车
            logging.info('点击路线，点击打车')
            SeaOfStarsAW.trace_thread.add_log('高德地图', '点击路线，点击打车')
            # 界面判断
            ...
            time.sleep(2)
            SeaOfStarsAW.ut_device(label="打车").click()
            time.sleep(2)
            ...
            # while not SeaOfStarsAW.ut_device(label="tips.route_line").exists:
