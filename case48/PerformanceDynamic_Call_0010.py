...
class PerformanceDynamic_Call_0010(Case):
    ...
    def run_case(self):
        ...
        for test_time in range(0, self.TEST_TIME):
            ...
            logging.info('4、点击搜索框，输入atest，点击第一条搜索记录')
