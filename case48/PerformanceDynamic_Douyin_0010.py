...
class PerformanceDynamic_Douyin_0010(Case):
    ...
    def run_case(self):
        ...
        for test_time in range(0, self.TEST_TIME):
            ...
            # 2、浏览推荐视频10s
            SeaOfStarsAW.trace_thread.add_log('抖音', '2、浏览推荐视频10s')
            time.sleep(10)

            # 3、上下切换视频，切换2s，切换5次
            SeaOfStarsAW.trace_thread.add_log('抖音', '3、上下切换视频，切换2s，切换5次')
            for i in range(5):
            ...
            # 5、返回抖音首页
            SeaOfStarsAW.trace_thread.add_log('抖音', '5、返回抖音首页')
            SeaOfStarsAW.ut_device.swipe_right()
            time.sleep(2)

            # 6、点击我-关注，点击胡锡进头像查看博主主页信息，等待2s
            SeaOfStarsAW.trace_thread.add_log('抖音', '6、点击我-关注，点击胡锡进头像查看博主主页信息，等待2s')
            ...
            # 7、上滑5次、下滑5次，等待2s
            SeaOfStarsAW.trace_thread.add_log('抖音', '7、上滑5次、下滑5次，等待2s')
            for i in range(5):
                SeaOfStarsAW.ut_device.swipe_up()
            for i in range(5):
            ...
            # 11、左滑返回博主主页，1s
            SeaOfStarsAW.trace_thread.add_log('抖音', '11、左滑返回博主主页，1s')
            for i in range(1):
                SeaOfStarsAW.ut_device.swipe_right()
            time.sleep(2)

            # 12、点击播放第二个视频，浏览15s
            SeaOfStarsAW.trace_thread.add_log('抖音', '12、点击播放第二个视频，浏览15s')
            ...
            SeaOfStarsAW.trace_thread.add_log('抖音', '14、滑动浏览评论，上滑5次，下滑5次，每次停留2s')
            for i in range(5):
                SeaOfStarsAW.ut_device.swipe_up()
            for i in range(5):
                SeaOfStarsAW.ut_device.swipe_down()
            ...
            # 15、左滑返回博主主页，1s
            SeaOfStarsAW.trace_thread.add_log('抖音', '15、左滑返回博主主页，1s')
            for i in range(2):
                SeaOfStarsAW.ut_device.swipe_right()
            time.sleep(2)

            # 16、点击播放第三个视频，浏览15s
            SeaOfStarsAW.trace_thread.add_log('抖音', '16、点击播放第三个视频，浏览15s')
            ...
            SeaOfStarsAW.trace_thread.add_log('抖音', '18、滑动浏览评论，上滑5次，下滑5次，每次停留2s')
            for i in range(5):
                SeaOfStarsAW.ut_device.swipe_up()
            for i in range(5):
                SeaOfStarsAW.ut_device.swipe_down()
            ...
            # 19、左滑返回博主主页，1s
            SeaOfStarsAW.trace_thread.add_log('抖音', '19、左滑返回博主主页，1s')
            for i in range(2):
                SeaOfStarsAW.ut_device.swipe_right()
            time.sleep(2)
            ...
            # 23、点击首页，返回推荐页面，2s
            SeaOfStarsAW.trace_thread.add_log('抖音', '23、点击首页，返回推荐页面，2s')
            for i in range(2):
                SeaOfStarsAW.ut_device.swipe_right()
            time.sleep(2)
            ...
            # 24、返回home页，等待2s
            SeaOfStarsAW.trace_thread.add_log('抖音', '24、返回home页，等待2s')
