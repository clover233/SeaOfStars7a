...
class PerformanceDynamic_Appmarket_0010(Case):
    ...
    def run_case(self):
        ...
        for test_time in range(0, self.TEST_TIME):
            ...
            # 12、返回首页(停留2s)
            logging.info('12、返回首页')
            SeaOfStarsAW.trace_thread.add_log('应用市场', '返回首页')
            SeaOfStarsAW.ut_device.swipe(0.010, 0.809, 0.933, 0.805, 0.5)
            time.sleep(2)

            # 13、返回Home界面(停留2s)
            logging.info('13、返回Home界面')
            ...
            time.sleep(2)
            SeaOfStarsAW.ut_device.app_terminate('com.apple.AppStore')
