...
class PerformanceDynamic_xhs_0030(Case):
    ...
    def run_case(self):
        ...
        for test_time in range(0, self.TEST_TIME):
            ...
            step3 = "3、搜索 穿搭图片（停留1s）返回上一级 停留1s 重复3次"
