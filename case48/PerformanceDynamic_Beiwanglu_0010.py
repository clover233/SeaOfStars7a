...
class PerformanceDynamic_Beiwanglu_0010(Case):
    ...
    def run_case(self):
        ...
        for test_time in range(0, self.TEST_TIME):
            ...
            # 5、点击屏幕底部待办，切换到待办页
            logging.info('5、点击屏幕底部待办，切换到待办页')
