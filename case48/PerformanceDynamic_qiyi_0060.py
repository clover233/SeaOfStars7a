...
class PerformanceDynamic_qiyi_0060(Case):
    ...
    def run_case(self):
        ...
        for test_time in range(0, self.TEST_TIME):
            ...
            time.sleep(2)
            logging.info('点击综艺')
            # SeaOfStarsAW.trace_thread.add_log('爱奇艺', '点击综艺')
            SeaOfStarsAW.ut_device.click(0.426, 0.35)
            time.sleep(2)
            logging.info('点击主页第1个推荐视频')  # 注意有广告情况)
            SeaOfStarsAW.ut_device.click(0.17, 0.617)
            time.sleep(10)
