...
class PerformanceDynamic_Douyin_0040(Case):
    ...
    def run_case(self):
        ...
        for test_time in range(0, self.TEST_TIME):
            ...
            SeaOfStarsAW.trace_thread.add_log('抖音', '1、启动抖音，上下滑动10次')
            ...
            # 14、下滑三次浏览推荐商品，2s
            SeaOfStarsAW.trace_thread.add_log('抖音', '14、下滑三次浏览推荐商品，2s')
            for i in range(3):
                SeaOfStarsAW.ut_device.swipe_down()
            time.sleep(2)
            ...
            # 16、上滑三次浏览推荐商品，2s
            SeaOfStarsAW.trace_thread.add_log('抖音', '16、上滑三次浏览推荐商品，2s')
            for i in range(3):
                SeaOfStarsAW.ut_device.swipe_up()
            time.sleep(2)

            # 17、下滑三次浏览推荐商品，2s
            SeaOfStarsAW.trace_thread.add_log('抖音', '17、下滑三次浏览推荐商品，2s')
            for i in range(3):
                SeaOfStarsAW.ut_device.swipe_down()
            time.sleep(2)

            # 18、点击第一个商品，2s
            SeaOfStarsAW.trace_thread.add_log('抖音', '18、点击第一个商品，2s')
            SeaOfStarsAW.ut_device.click(0.178, 0.326)
            time.sleep(2)

            # 19、上滑三次浏览推荐商品，2s
            SeaOfStarsAW.trace_thread.add_log('抖音', '19、上滑三次浏览推荐商品，2s')
            for i in range(3):
                SeaOfStarsAW.ut_device.swipe_up()
            time.sleep(2)

            # 20、点击左下角客服，2s
            SeaOfStarsAW.trace_thread.add_log('抖音', '20、点击左下角客服，2s')
            SeaOfStarsAW.ut_device.click(0.191, 0.924)
            time.sleep(2)

            # 21、返回到商品详情页，2s
            SeaOfStarsAW.trace_thread.add_log('抖音', '21、返回到商品详情页，2s')
            SeaOfStarsAW.ut_device.swipe_right()
            time.sleep(2)

            # 22、点击左下角进入店铺，2s
            SeaOfStarsAW.trace_thread.add_log('抖音', '22、点击左下角进入店铺，2s')
            SeaOfStarsAW.ut_device.click(0.075, 0.924)
            time.sleep(2)

            # 23、上滑三次浏览推荐商品，2s
            SeaOfStarsAW.trace_thread.add_log('抖音', '23、上滑三次浏览推荐商品，2s')
            for i in range(3):
                SeaOfStarsAW.ut_device.swipe_up()
            time.sleep(2)

            # 24、点击首页，返回推荐页面，2s
            SeaOfStarsAW.trace_thread.add_log('抖音', '24、点击首页，返回推荐页面，2s')
            for i in range(5):
                SeaOfStarsAW.ut_device.swipe_right()
            time.sleep(2)
            ...
            # 25、点击长视频，2s
            SeaOfStarsAW.trace_thread.add_log('抖音', '25、点击长视频，2s')
            SeaOfStarsAW.ut_device(labelContains="精选").click()
            time.sleep(2)

            # 26、向左滑动，依次切换顶部tab页（长视频-关注-商城-推荐），循环3次
            SeaOfStarsAW.trace_thread.add_log('抖音', '26、向左滑动，依次切换顶部tab页（长视频-关注-商城-推荐），循环3次')
            for i in range(3):
                ...
                time.sleep(2)
            # 27、返回home页，等待2s
            SeaOfStarsAW.trace_thread.add_log('抖音', '27、返回home页，等待2s')
