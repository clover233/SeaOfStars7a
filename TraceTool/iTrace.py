    ...
    def run(self):
        ...
        while 1:
            ...
            while self.isLetTraceRun:
                ...
                #            '--all-processes', '--output', temptrace_path, "--time-limit", '410s']
                command = ['xctrace', 'record', '--device-name', "iPhone17 (26.0)", '--template',
                           '/Users/kare/PycharmProjects/SeaOfStars/TraceTool/Templates/MyTemplate0924.tracetemplate','--all-processes', '--output', temptrace_path, "--time-limit", '600s']
