...
class PerformanceDynamic_Alipay_0020(Case):
    ...
    def run_case(self):
        ...
        for test_time in range(0, self.TEST_TIME):
            ...
            SeaOfStarsAW.ut_device.click(0.618, 0.589)
            time.sleep(2)
